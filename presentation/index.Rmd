...
.right-column[
```{r, ref.label= "ggdotchart", fig.align='center', out.width="90%"}
```
]
...
.right-column[
```{r, ref.label= "did-explain", fig.align='center', out.width="90%"}
```
]
...
.right-column[
```{r, ref.label= "ela-comparison", fig.align='center', out.width="90%"}
```
]
???
...
.right-column[
```{r, ref.label= "achievement", fig.align='center', out.width="90%"}
```
]
...
.right-column[
```{r, ref.label= "achievement-gap", fig.align='center', out.width="90%"}
```
]
